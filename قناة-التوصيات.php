...
<body>
    ...
    <form id="tradingForm" action="">
        ...
        <label for="timeframe">اختر الفترة الزمنية</label>
        <div class="timeframe-options">
            <label class="radio-label">
                <input type="radio" id="one_month" name="timeframe" value="1 month" required>
                <span class="radio-custom"></span>
                شهر واحد
            </label>
            <label class="radio-label">
                <input type="radio" id="three_months" name="timeframe" value="3 months">
                <span class="radio-custom"></span>
                ثلاثة أشهر
            </label>
            <label class="radio-label">
                <input type="radio" id="six_months" name="timeframe" value="6 months">
                <span class="radio-custom"></span>
                ست أشهر
            </label>
            <label class="radio-label">
                <input type="radio" id="one_year" name="timeframe" value="1 year">
                <span class="radio-custom"></span>
                سنة واحدة
            </label>
        </div>
...
document.getElementById('tradingForm').onsubmit = function(event) {
    ...
    const subject = `Subscribe to the recommendations channel From ${name}`;
