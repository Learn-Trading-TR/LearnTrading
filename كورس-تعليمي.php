...
<div class="form-container">
    <form id="tradingForm" action="">
        ...
        <label for="course_level">اختر مستوى الدورة</label>
        <div class="timeframe-options">
            <label class="radio-label">
                <input type="radio" id="beginner" name="course_level" value="Beginner - 15 days / $50" required>
                <span class="radio-custom"></span>
                $مبتدأ - 15 يوم / 50
            </label>
            <label class="radio-label">
                <input type="radio" id="advanced" name="course_level" value="Advanced - 30 days / $150">
                <span class="radio-custom"></span>
                $متقدم - 30 يوم / 150
            </label>
            <label class="radio-label">
                <input type="radio" id="professional" name="course_level" value="Professional - 60 days / $300">
                <span class="radio-custom"></span>
                $محترف - 60 يوم / 300
            </label>
        </div>
...
document.getElementById('tradingForm').onsubmit = function(event) {
    ...
    const courseLevel = document.querySelector('input[name="course_level"]:checked').value;

    const subject = `Register an educational course From ${name}`;
    const body = `Name: ${name}\nEmail: ${email}\nPhone: ${phone}\nSelected Course: ${courseLevel}`;
