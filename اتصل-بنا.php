...
<h1 class="SSH2">:تابعنا على</h1>
<div class="social-media-boxes">
<div class="box"><a href="https://wa.me/+905312921932"><i class="fa-solid fa-phone"></i></a></div>
<div class="box"><a href="https://wa.me/+447846502765"><i class="fa-brands fa-whatsapp"></i></a></div>
<div class="box"><a href="http://t.me/Learntranding"><i class="fa-brands fa-telegram"></i></a></div>
<div class="box"><a href="https://www.facebook.com/profile ?id=61561309606508&mibextid=ZbWKwL"><i class="fab fa-facebook-f"></i></a></div>
<div class="box"><a href="https://www.instagram.com/learntrading.tr?igsh=MWRieTg4bXBvZW9odQ=="><i class="fab fa-instagram"></i></a></div>
<div class="box"><a href="https://www.tiktok.com/@learntrading.tr?_t=8pk3PuGU00s&_r=1"><i class="fa-brands fa-tiktok"></i></a></div>
  </div>

  <h1 class="SSH1">اتصل بنا</h1>
  <div class="CFB">
  <form class="contact-form">
    ...
    <button type="submit" id="mailto-link">إرسال</button>
  </form>
</div>
