...
<div class="MT-section">
    <h2>منصات التداول</h2>
    <p>تعلم التداول توفر لك القوة والمرونة التي تحتاجها في يديك مع منصتي التداول الرائدتين في السوق MetaTrader 4 و MetaTrader 5 سواء كنت تفضل التداول عبر الفوركس، الأسهم، أو السلع، ستجد كل ما تحتاجه على منصتينا</p>
    ...
    <div class="MT-box">
            ...
            <p>MetaTrader 5</p>
            <span>MT5 هو برنامج تداول عبر الإنترنت ومنصة تحليل مالي تتيح للمستخدمين تداول الأسهم، العقود الآجلة، والفوركس، بالإضافة إلى العديد من أدوات الأسواق الأخرى. تم تطوير MT5 ليكون أكثر مرونة وقوة من MT4، مع ميزات جديدة تساعد المتداولين على تحقيق أفضل النتائج.</span>
            <a href="MT5.php">المزيد من التفاصيل</a>
        </div>
        <div class="MT-box">
            <img src="https://brilanet.s3.amazonaws.com/wp-content/uploads/2022/10/25204220/MT4.jpeg" alt="MT4">
            <p>MetaTrader 4</p>
            <span>MT4 هو برنامج تداول عبر الإنترنت يتيح للمستخدمين تداول الأسهم، العقود الآجلة، والفوركس. وهو يعتبر المنصة الأكثر شيوعاً وشعبية في عالم التداول الإلكتروني، بشكل خاص في تداول الفوركس.</span>
            <a href="MT4.php">المزيد من التفاصيل</a>
        </div>
</div>
