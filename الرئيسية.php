...
if (!isset($_SESSION['user_id'])) {
    $_SESSION['login_first_msg'] = "يجب عليك تسجيل الدخول أولاً.";
}
...
<div class="swiper-container">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="Swiper imgs/Swiper (1).jpg" alt="Slide 1">
            <div class="slide-text">لا يتعلق الأمر بالتداول، بل بكيفية التداول</div>
        </div>
        <div class="swiper-slide">
            <img src="Swiper imgs/Swiper (2).jpg" alt="Slide 2">
            <div class="slide-text">الأسواق العالمية ليست للمحترفين فقط</div>
        </div>
        <div class="swiper-slide">
            <img src="Swiper imgs/Swiper (3).jpg" alt="Slide 3">
            <div class="slide-text">منصتك الأمثل لفهم الأسواق العالمية والتفوق فيها</div>
        </div>
        <div class="swiper-slide">
            <img src="Swiper imgs/Swiper (4).jpg" alt="Slide 4">
            <div class="slide-text">التعليم الذي تحتاجه للوصول إلى قمة النجاح في الأسواق المالية</div>
        </div>
    </div>
</div>
...
<div class="boxes-container">
    <div class="box">
        ...
        <h2>التداول الذكي</h2>
        <p>تعلم كيفية التداول بذكاء وتحقيق الأرباح في الأسواق العالمية</p>
    </div>
    <div class="box">
        <i class="fas fa-graduation-cap"></i>
        <h2>تعليم احترافي</h2>
        <p>دروس احترافية ومعلومات قيمة تساعدك على فهم الأسواق بشكل أفضل</p>
    </div>
    <div class="box">
        <i class="fas fa-users"></i>
        <h2>مجتمع داعم</h2>
        <p>انضم إلى مجتمع من المتداولين المحترفين وتبادل الخبرات والأفكار</p>
    </div>
    <div class="box">
        <i class="fas fa-tools"></i>
        <h2>أدوات قوية</h2>
        <p>استخدم أدواتنا المتطورة لتحليل السوق واتخاذ قرارات أفضل.</p>
    </div>
</div>
...
<div class="services-section">
    <h2>الخدمات</h2>
    <p>قسم الخدمات يوفر نظرة شاملة على كل ما نقدمه، من الدورات التدريبية وتوصيات التداول، إلى دعم فتح حسابات التداول. سواء كنت مبتدئًا أو متداولًا محترفًا، ستجد هنا الأدوات والخدمات التي تلبي احتياجاتك وتطلعاتك.</p>
    
    <div class="services-container">
        <div class="service-box">
            <i class="fas fa-chalkboard-teacher"></i>
            <p>دروس التدريبية</p>
            <span>تعلم المهارات اللازمة للتداول بفعالية. نقدم دورات تعليمية تغطي أساسيات التداول، التحليل الفني، واستراتيجيات السوق المتقدمة.</span>
            <a href="دروس-التدريبية.php">المزيد من التفاصيل</a>
        </div>
        <div class="service-box">
            <i class="fas fa-chart-line"></i>
            <p>توصيات التداول</p>
            <span>الحصول على توصيات تداول دقيقة ومحدثة. نساعدك في اتخاذ قرارات استثمارية مستنيرة من خلال تحليلات السوق المتعمقة.</span>
            <a href="توصيات-تداول.php">المزيد من التفاصيل</a>
        </div>
        <div class="service-box">
            <i class="fas fa-users"></i>
            <p>فتح حساب تداول</p>
            <span>فريق دعم متاح لمساعدتك على مدار الساعة. نقدم الدعم الفني والإجابات على استفساراتك في أي وقت.</span>
            <a href="فتح-حساب-تداول.php">المزيد من التفاصيل</a>
        </div>
        <div class="service-box">
            <i class="fas fa-graduation-cap"></i>
            <p>الاستثمار وإدارة المحافظ</p>
            <span>معلومات شاملة حول كيفية إدارة استثماراتك. تعلم كيفية بناء محفظة استثمارية ناجحة وتحقيق أهدافك المالية.</span>
            <a href="الاستثمار-وإدارة-المحافظ.php">المزيد من التفاصيل</a>
        </div>
    </div>
</div>
...
<div class="about-container">
    <h2>تعلم التداول</h2>
    <p>هي شركة رائدة في مجال التدريب على الأسواق العالمية. نحن نسعى إلى تقديم فرصة التعلم الجديدة والمتقدمة لكل من يبحث عن فهم أعمق للأسواق المالية العالمية. مع خدماتنا المميزة التي تشمل توصيات التداول المجانية والمدفوعة، نحن نقدم لعملائنا رؤية فريدة لتحقيق النجاح في الأسواق المالية. بالإضافة إلى ذلك، نحن نوفر خدمة فتح حسابات التداول لتسهيل عملية الاستثمار لعملائنا.</p>
    
    <h3>الخبرة:</h3>
    <p>لدينا فريق من الخبراء الماليين والمتداولين المحترفين ذوي الخبرة العميقة في الأسواق المالية.</p>
    
    <h3>التعليم المركز على العملية:</h3>
    <p>نحن نركز على تقديم التدريب العملي الذي يتيح للمتداولين فهم الأسواق الحقيقية وكيفية التفاعل معها.</p>
    
    <h3>التوصيات الدقيقة:</h3>
    <p>في تعلم التداول نقدم توصيات تداول مجانية ومدفوعة تتميز بالدقة والجودة.</p>
    
    <h3>الدعم المتواصل:</h3>
    <p>نقدم الدعم المتواصل للمتداولين في جميع مراحل رحلتهم، من فتح الحسابات إلى إدارة المخاطر وتحقيق الأرباح.</p>
    
    <h3>التكنولوجيا الحديثة:</h3>
    <p>نستخدم أحدث التكنولوجيات لتوفير تجربة تداول سلسة في تعلم التداول.</p>
    
    <div class="features-container">
        <img src="imgs/Fet.png" alt="Description" class="features-image">
        <ul class="features">
            <li><span>تدريب شامل</span><i class="fas fa-chalkboard-teacher"></i></li>
            <li><span>توصيات دقيقة</span><i class="fas fa-chart-line"></i></li>
            <li><span>الدعم المستمر</span><i class="fas fa-users"></i></li>
            <li><span>الاستشارات المالية</span><i class="fas fa-comments"></i></li>
            <li><span>الأمان والخصوصية</span><i class="fas fa-lock"></i></li>
            <li><span>حسابات مجانية</span><i class="fas fa-wallet"></i></li>
            <li><span>فروقات أسعار طفيفة</span><i class="fas fa-arrow-up"></i></li>
            <li><span>رافعة مالية مخصصة</span><i class="fas fa-exchange-alt"></i></li>
        </ul>
    </div>
</div>
